...
public class PropertyBeanAdapter2 extends RecyclerView.Adapter<PropertyBeanAdapter2.ViewHolder> {

    private Activity activity;
    private ArrayList<PropertyBean2> dataArrayList;
    ApiService apiService;

    public PropertyBeanAdapter2(Activity activity, ArrayList<PropertyBean2> dataArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        PropertyBean2 propertyBean = dataArrayList.get(position);
